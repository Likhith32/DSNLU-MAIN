...
export default function FashionMediaEntertainmentLawsPage() {
    return (
        <div className="min-h-screen bg-slate-50 pb-12">
            <Banner title="Fashion, Media and Entertainment Laws" />
                ...
                <Card className="border-none shadow-lg">
                    <CardHeader className="bg-white pb-2 pt-6">
                        <CardTitle className="text-2xl font-bold text-dsnlu-dark-blue md:text-3xl">
                            Fashion, Media and Entertainment Laws
                        </CardTitle>
                    </CardHeader>
